...
namespace Utils {
    ...
    void SHA256::pad() {
        ...
        uint64_t totalBits = bitCount + (bufferSize * 8);
        buffer[56] = totalBits >> 56;
        buffer[57] = totalBits >> 48;
        buffer[58] = totalBits >> 40;
        buffer[59] = totalBits >> 32;
        buffer[60] = totalBits >> 24;
        buffer[61] = totalBits >> 16;
        buffer[62] = totalBits >> 8;
        buffer[63] = totalBits;
