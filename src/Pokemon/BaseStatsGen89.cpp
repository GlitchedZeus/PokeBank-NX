        ...
        if (form == 1) {
            switch (speciesId) {
                ...
                case 554: case 555: case 562: case 618: {
                    const BaseStatsGen89* stats = searchFormArray(
                        BASE_STATS_TABLE_GALARIAN,
                        sizeof(BASE_STATS_TABLE_GALARIAN) / sizeof(BASE_STATS_TABLE_GALARIAN[0]),
                        speciesId
                    );
                    if (stats) return stats;
                    break;
                ...
                case 503: case 549: case 570: case 571: case 705: case 706: case 713: case 724: {
                    const BaseStatsGen89* stats = searchFormArray(
                        BASE_STATS_TABLE_HISUIAN,
                        sizeof(BASE_STATS_TABLE_HISUIAN) / sizeof(BASE_STATS_TABLE_HISUIAN[0]),
                        speciesId
                    );
                    if (stats) return stats;
                    break;
                ...
                case 194: { // Wooper
                    const BaseStatsGen89* stats = searchFormArray(
                        BASE_STATS_TABLE_PALDEAN,
                        sizeof(BASE_STATS_TABLE_PALDEAN) / sizeof(BASE_STATS_TABLE_PALDEAN[0]),
                        speciesId
                    );
                    if (stats) return stats;
                    break;
