...
// Bounded read-only traversal of approved RetroArch save roots. Only .sav/.srm normal battery
// saves are considered. Crystal can be identified structurally. Gold vs Silver is never guessed
// from bytes: a strict GS-family save requires one trusted release/path hint or stays ambiguous.
