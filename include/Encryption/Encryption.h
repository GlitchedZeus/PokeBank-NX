 ...
 *
 * The shuffle value (SV) is derived from bits 13-17 of the personality value (PV):
 *   SV = (PV >> 13) & 31
 *
...
static const std::uint8_t blockPosition[128] = {
    ...
    // Duplicates of 0-7 to eliminate modulus (SV 24-31)
    0, 1, 2, 3,
    0, 1, 3, 2,
    0, 2, 1, 3,
    0, 3, 1, 2,
