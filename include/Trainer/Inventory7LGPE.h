...
namespace Trainer {
    ...
    inline const PouchInfo7LGPE& getPouchInfo7LGPE(PouchType7LGPE type) {
        ...
        static const PouchInfo7LGPE pouches[] = {
            {PouchType7LGPE::Medicine, "Medicines",    0x0000, 60},   // 0x0000-0x00EF = 240 bytes = 60 slots
            {PouchType7LGPE::TMs,      "TMs",          0x00F0, 108},  // 0x00F0-0x029F = 432 bytes = 108 TMs
            {PouchType7LGPE::PowerUp,  "Power-Ups",    0x05C0, 150},  // 0x05C0-0x0817 = 600 bytes = 150 slots
            {PouchType7LGPE::Candy,    "Candies",      0x02A0, 200},  // 0x02A0-0x05BF = 800 bytes = 200 candies
            {PouchType7LGPE::Balls,    "Poké Balls",   0x0818, 50},   // 0x0818-0x08DF = 200 bytes = 50 slots
            {PouchType7LGPE::Battle,   "Battle Items", 0x08E0, 150},  // 0x08E0-0x0B37 = 600 bytes = 150 slots
            {PouchType7LGPE::KeyItems, "Other Items",  0x0B38, 150}   // 0x0B38-0x0D8F: PKHeX "Items" pouch = general + key items mixed
        };
