...
namespace Trainer {
    ...
    inline const PouchInfo3FRLG& getPouchInfo3FRLG(PouchType3FRLG type) {
        static const PouchInfo3FRLG pouches[] = {
            {PouchType3FRLG::Items,    "Items",       0x310, 42, true},
            {PouchType3FRLG::KeyItems, "Key Items",   0x3B8, 30, true},
            {PouchType3FRLG::Balls,    "Poké Balls",  0x430, 13, true},
            {PouchType3FRLG::TMHM,     "TM Case",     0x464, 58, true},
            {PouchType3FRLG::Berries,  "Berry Pouch", 0x54C, 43, true},
            {PouchType3FRLG::PCItems,  "PC Items",    0x298, 30, false},
        };
